// *********************************************************************************************************************
//  RUTA: frontend/src/pages/SobreRedetas.js
// 
// 🔹 Este componente presenta la información del proyecto y la autoría de la aplicación web.
// *********************************************************************************************************************

/**
 * @fileoverview Vista estática informativa sobre el proyecto Redetas.
 * Renderiza los detalles de la aplicación, el contexto del Proyecto Intermodular y el stack tecnológico utilizado.
...
/**
 * Componente funcional SobreRedetas.
 * 
 * @returns {JSX.Element} Interfaz con la presentación del proyecto y de la desarrolladora.
 */
function SobreRedetas() {
    // Recuperación de la sesión actual para renderizar opciones condicionales en la navegación superior
    ...
    return (
        <div style={{ backgroundColor: '#fdfaf7', minHeight: '100vh', paddingBottom: '50px' }}>
            ...
            {/* SECCIÓN: CONTENIDO DE PRESENTACIÓN */}
            <main style={{ maxWidth: '800px', margin: '60px auto', padding: '0 20px' }}>
                ...
                <div style={{ backgroundColor: 'white', borderRadius: '20px', padding: '50px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)', textAlign: 'center' }}>
                    ...
                    {/* Contenedor con propiedades estrictas de enmascaramiento circular para la imagen de perfil */}
                    <div style={{
                        width: '150px',
                        height: '150px',
                        borderRadius: '50%', 
                    ...
                    <div style={{ textAlign: 'left', backgroundColor: '#fdf8f5', padding: '30px', borderRadius: '15px', color: '#555', fontSize: '18px', lineHeight: '1.7' }}>
                        <p style={{ margin: 0 }}>
                            Este proyecto ha sido desarrollado como Trabajo de Fin de Grado, ahora llamado <strong> Proyecto Intermodular de Desarrollo de Aplicaciones Web</strong>. Mi objetivo ha sido aplicar todos los conocimientos adquiridos en la formación profesional, desde el diseño de la base de datos en MongoDB hasta la lógica del servidor en Node.js y la interfaz de usuario con React.
                        </p>
                    </div>
...
// ==========================================
// DEFINICIÓN DE ESTILOS ESTÁTICOS (CSS-in-JS)
// ==========================================
